...
func waitFor(t *testing.T, condition func() bool, message string) {
	t.Helper()
	// CI runners can take several seconds to fsync and drain the 500-record WAL
	// concurrency case. Keep the assertion bounded without coupling it to a
	// workstation-speed one-second deadline.
