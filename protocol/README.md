...
language-neutral ingestion schema is `protocol/proto/nodeflow/v1/telemetry.proto`; its checked-in Go binding
is generated into `runtime/go/gen/nodeflow/v1/telemetry.pb.go`. Topology snapshots use the
...
[`@mshamed1/node-flow-topology-engine`](https://github.com/msHamed1/node-flow/tree/main/reference/topology#readme)
